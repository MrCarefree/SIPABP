                ...
                <form id="form-add" enctype="multipart/form-data">
                    <div class="form-group clearfix">
                        <div class="icheck-primary d-inline">
                            <input type="radio" name="type" id="add_existing" checked class="add_type" value="existing">
                            <label for="add_existing">Existing Item</label>
                        </div>
                        <div class="icheck-primary d-inline">
                            <input type="radio" name="type" id="add_new" class="add_type" value="new">
                            <label for="add_new">New Item</label>
                        </div>
                    </div>
                    <div class="form-group" id="add-barang-container">
                        <label for="add-barang">Alat/Bahan</label>
                        <select name="barang" id="add-barang" class="form-control select2">
                            <option value=""></option>
                        </select>
                    </div>
                    <div class="form-group" id="add-nama-barang-container" style="display: none">
                        <label for="add-nama-barang">Nama Barang</label>
                        <input type="text" name="nama_barang" id="add-nama-barang" class="form-control">
                    </div>
                    <div class="form-group" id="add-gambar-container" style="display:none;">
                        ...
                        <div class="input-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="add-gambar"
                                       aria-describedby="upload-gambar" name="gambar">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="jumlah_barang" id="add-jumlah-barang" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="add-harga-satuan">Harga Satuan</label>
                        <input type="number" name="harga_satuan" id="add-harga-satuan" class="form-control">
                    </div>
                    <div class="form-group">
