            ...
            <div class="modal-body">
                ...
                <form id="form-edit" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_barang" id="edit-nama-barang" class="form-control">
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="edit-gambar"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="jumlah_barang" id="edit-jumlah-barang" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="edit-harga-satuan">Harga Satuan</label>
                        <input type="number" name="harga_satuan" id="edit-harga-satuan" class="form-control">
                    </div>
                    <div class="form-group">
